...
export class DocumentEndpoints {
    public postLinkDocumentToGroups = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        if (!req.body.documentRefId || !req.body.groups) {
            throw new Error("Invalid request: parameter 'documentRefId' or 'groups' is not set in body")
        }
    ...
    public getAllDocuments = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
