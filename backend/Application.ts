...
export class Application {
    ...
    private static handleExit(express: ExpressServer, mongoDBService: MongoDBService) {
    ...
    private static shutdownProperly(exitCode: number, express: ExpressServer, mongoDBService: MongoDBService) {
        Promise.resolve()
            .then(() => express.kill())
            .then(() => {
